...
AddOutputFilter chunkFilter
		...
		<Item Name="Testing Your System" Type="Folder">
			<Item Name="Main_Ambient Light Sensor.vi" Type="VI" URL="../Main_Ambient Light Sensor.vi"/>
			<Item Name="Main_DC.vi" Type="VI" URL="../Main_DC.vi"/>
			<Item Name="Main_Gyro.vi" Type="VI" URL="../Main_Gyro.vi"/>
			<Item Name="Main_IR Range Finder.vi" Type="VI" URL="../Main_IR Range Finder.vi"/>
			<Item Name="Main_SERVO.vi" Type="VI" URL="../Main_SERVO.vi"/>
		</Item>
		<Item Name="Dependencies" Type="Dependencies">
