...
<Project Type="Project" LVVersion="17008000">
	...
	<Item Name="NI-myRIO-1900-030d40fb" Type="RT myRIO">
		<Property Name="alias.name" Type="Str">NI-myRIO-1900-030d40fb</Property>
...
AddOutputFilter chunkFilter
		...
		<Item Name="movement" Type="Folder">
			<Item Name="Addition" Type="Folder">
				<Item Name="(LEFT)alignment by encoders for rotation.vi" Type="VI" URL="../movement/(LEFT)alignment by encoders for rotation.vi"/>
				<Item Name="(RIGHT)alignment by encoders for rotation.vi" Type="VI" URL="../movement/(RIGHT)alignment by encoders for rotation.vi"/>
			</Item>
			<Item Name="move forward(side) by sonic" Type="Folder">
				<Item Name="movement(a side) fwd use navX and Sonic.vi" Type="VI" URL="../movement/movement(a side) fwd use navX and Sonic.vi"/>
			</Item>
			<Item Name="rotation" Type="Folder">
				<Item Name="alignment by unt corner.vi" Type="VI" URL="../movement/alignment by unt corner.vi"/>
				<Item Name="motor (SubVI).vi" Type="VI" URL="../movement/motor (SubVI).vi"/>
				<Item Name="rotation.vi" Type="VI" URL="../movement/rotation.vi"/>
				<Item Name="turn unt current.vi" Type="VI" URL="../movement/turn unt current.vi"/>
			</Item>
			<Item Name="movement fwd use navX.vi" Type="VI" URL="../movement/movement fwd use navX.vi"/>
			<Item Name="navX x_y_z (SubVI).vi" Type="VI" URL="../movement/navX x_y_z (SubVI).vi"/>
		</Item>
		<Item Name="de santimeters by encoder.vi" Type="VI" URL="../movement/de santimeters by encoder.vi"/>
		<Item Name="for axis(360) (SubVI).vi" Type="VI" URL="../movement/for axis(360) (SubVI).vi"/>
		<Item Name="forwardByNavX_theSide(queuesWithNavX).vi" Type="VI" URL="../movement/forwardByNavX_theSide(queuesWithNavX).vi"/>
		<Item Name="full.vi" Type="VI" URL="../movement/full.vi"/>
		<Item Name="movement back by santimeters.vi" Type="VI" URL="../movement/movement back by santimeters.vi"/>
		<Item Name="movement forward by santimeters.vi" Type="VI" URL="../movement/movement forward by santimeters.vi"/>
		<Item Name="rotate(NORMALNOE ROTATE).vi" Type="VI" URL="../movement/rotate(NORMALNOE ROTATE).vi"/>
		<Item Name="value by encoders to santimeters for back (SubVI).vi" Type="VI" URL="../movement/value by encoders to santimeters for back (SubVI).vi"/>
		<Item Name="value by encoders to santimeters for forward (SubVI).vi" Type="VI" URL="../movement/value by encoders to santimeters for forward (SubVI).vi"/>
		<Item Name="Dependencies" Type="Dependencies">
