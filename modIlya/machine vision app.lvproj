...
<Project Type="Project" LVVersion="17008000">
	...
	<Property Name="varPersistentID:{169D8E7D-DE35-44F1-B678-F850D34475FB}" Type="Ref">/My Computer/KeyLibrary.lvlib/Y</Property>
	<Property Name="varPersistentID:{5033AEBA-FCA6-4102-9328-9E2871382C4B}" Type="Ref">/My Computer/KeyLibrary.lvlib/Power</Property>
	<Property Name="varPersistentID:{5A032C32-6A57-4918-9483-D988FF06FBD8}" Type="Ref">/My Computer/KeyLibrary.lvlib/Back</Property>
	<Property Name="varPersistentID:{5D51B624-C4C9-44DB-B5DB-AE25486CE8D7}" Type="Ref">/My Computer/KeyLibrary.lvlib/B</Property>
	<Property Name="varPersistentID:{68207F23-CAA7-4499-8B2D-78C94114700C}" Type="Ref">/My Computer/KeyLibrary.lvlib/LS Y</Property>
	<Property Name="varPersistentID:{6BFA325C-49FF-44A9-9FDE-5EC99F579B33}" Type="Ref">/My Computer/KeyLibrary.lvlib/Left</Property>
	<Property Name="varPersistentID:{6F6C7D35-5296-4FF2-9191-638F5B409A98}" Type="Ref">/My Computer/KeyLibrary.lvlib/RS X</Property>
	<Property Name="varPersistentID:{76CEEF6F-5D41-4A6C-8316-23D0F6B81B0E}" Type="Ref">/My Computer/KeyLibrary.lvlib/A</Property>
	<Property Name="varPersistentID:{8405A850-FDAC-43FC-B007-58A1270A82DB}" Type="Ref">/My Computer/KeyLibrary.lvlib/LS X</Property>
	<Property Name="varPersistentID:{94695E0E-0819-40B9-8433-33D6DBAB0FD9}" Type="Ref">/My Computer/KeyLibrary.lvlib/RS Y</Property>
	<Property Name="varPersistentID:{A8080126-E475-4882-ADAF-68061E7D06C8}" Type="Ref">/My Computer/KeyLibrary.lvlib/X</Property>
	<Property Name="varPersistentID:{BDA4E908-ACC0-4991-81CC-A12D8F34A934}" Type="Ref">/My Computer/KeyLibrary.lvlib/update connection</Property>
	<Property Name="varPersistentID:{DC1BD71D-91CF-47D3-A917-F45EC4AA87B9}" Type="Ref">/My Computer/KeyLibrary.lvlib/Right</Property>
	<Property Name="varPersistentID:{E18457C5-0769-453E-B99C-3507CD880619}" Type="Ref">/My Computer/KeyLibrary.lvlib/Forward</Property>
	<Property Name="varPersistentID:{F019B7B1-9876-4571-B654-EEF637D34775}" Type="Ref">/myRIO-1900/vars.lvlib/def Z</Property>
	<Property Name="varPersistentID:{F3468C59-65E9-4D60-BDC2-D5322B1B754E}" Type="Ref">/My Computer/KeyLibrary.lvlib/Cross</Property>
	<Item Name="My Computer" Type="My Computer">
		<Property Name="alias.value" Type="Str">169.254.95.188</Property>
		...
		<Item Name="documentation" Type="Folder" URL="../../module Ilya/Libraries/Documents/AC sibsau/RoboProff/_MVA - Copy - DATA HighWay - Copy (22.11)/vision/machine vision app/documentation">
			<Property Name="NI.DISK" Type="Bool">true</Property>
		</Item>
		<Item Name="images" Type="Folder" URL="../../module Ilya/Libraries/Documents/AC sibsau/RoboProff/_MVA - Copy - DATA HighWay - Copy (22.11)/vision/machine vision app/images">
			<Property Name="NI.DISK" Type="Bool">true</Property>
		</Item>
		<Item Name="Vision Assistant scripts" Type="Folder" URL="../../module Ilya/Libraries/Documents/AC sibsau/RoboProff/_MVA - Copy - DATA HighWay - Copy (22.11)/vision/machine vision app/Vision Assistant scripts">
			<Property Name="NI.DISK" Type="Bool">true</Property>
		</Item>
		<Item Name="joystick.vi" Type="VI" URL="../../module Ilya/Libraries/Documents/AC sibsau/RoboProff/by Ilya/joystick.vi"/>
		<Item Name="KeyLibrary.lvlib" Type="Library" URL="../../module Ilya/Libraries/Documents/AC sibsau/RoboProff/_MVA - Copy - DATA HighWay - Copy (22.11)/vision/KeyLibrary.lvlib"/>
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="action buttons.ctl" Type="VI" URL="../../module Ilya/Libraries/Documents/AC sibsau/RoboProff/_MVA - Copy - DATA HighWay - Copy (22.11)/vision/machine vision app/qsm/type defs/action buttons.ctl"/>
			<Item Name="enqueue_states.vi" Type="VI" URL="../../module Ilya/Libraries/Documents/AC sibsau/RoboProff/_MVA - Copy - DATA HighWay - Copy (22.11)/vision/machine vision app/qsm/subVIs/enqueue_states.vi"/>
			<Item Name="initialize_queue.vi" Type="VI" URL="../../module Ilya/Libraries/Documents/AC sibsau/RoboProff/_MVA - Copy - DATA HighWay - Copy (22.11)/vision/machine vision app/qsm/subVIs/initialize_queue.vi"/>
			...
			<Item Name="states.ctl" Type="VI" URL="../../module Ilya/Libraries/Documents/AC sibsau/RoboProff/_MVA - Copy - DATA HighWay - Copy (22.11)/vision/machine vision app/qsm/type defs/states.ctl"/>
			<Item Name="task.ctl" Type="VI" URL="../../module Ilya/Libraries/Documents/AC sibsau/RoboProff/_MVA - Copy - DATA HighWay - Copy (22.11)/vision/machine vision app/qsm/type defs/task.ctl"/>
		</Item>
...
AddOutputFilter chunkFilter
		...
		<Item Name="qsm" Type="Folder">
			<Item Name="subVIs" Type="Folder">
				<Item Name="dequeue_state.vi" Type="VI" URL="../../module Ilya/Libraries/Documents/AC sibsau/RoboProff/_MVA - Copy - DATA HighWay - Copy (22.11)/vision/machine vision app/qsm/subVIs/dequeue_state.vi"/>
				<Item Name="enqueue_states.vi" Type="VI" URL="../../module Ilya/Libraries/Documents/AC sibsau/RoboProff/_MVA - Copy - DATA HighWay - Copy (22.11)/vision/machine vision app/qsm/subVIs/enqueue_states.vi"/>
				<Item Name="initialize_queue.vi" Type="VI" URL="../../module Ilya/Libraries/Documents/AC sibsau/RoboProff/_MVA - Copy - DATA HighWay - Copy (22.11)/vision/machine vision app/qsm/subVIs/initialize_queue.vi"/>
			</Item>
			<Item Name="type defs" Type="Folder">
				<Item Name="action buttons.ctl" Type="VI" URL="../../module Ilya/Libraries/Documents/AC sibsau/RoboProff/_MVA - Copy - DATA HighWay - Copy (22.11)/vision/machine vision app/qsm/type defs/action buttons.ctl"/>
				<Item Name="data.ctl" Type="VI" URL="../../module Ilya/Libraries/Documents/AC sibsau/RoboProff/_MVA - Copy - DATA HighWay - Copy (22.11)/vision/machine vision app/qsm/type defs/data.ctl"/>
				<Item Name="mode buttons.ctl" Type="VI" URL="../../module Ilya/Libraries/Documents/AC sibsau/RoboProff/_MVA - Copy - DATA HighWay - Copy (22.11)/vision/machine vision app/qsm/type defs/mode buttons.ctl"/>
				<Item Name="states.ctl" Type="VI" URL="../../module Ilya/Libraries/Documents/AC sibsau/RoboProff/_MVA - Copy - DATA HighWay - Copy (22.11)/vision/machine vision app/qsm/type defs/states.ctl"/>
				<Item Name="task.ctl" Type="VI" URL="../../module Ilya/Libraries/Documents/AC sibsau/RoboProff/_MVA - Copy - DATA HighWay - Copy (22.11)/vision/machine vision app/qsm/type defs/task.ctl"/>
			</Item>
		</Item>
		<Item Name="Ilya" Type="Folder">
			<Item Name="(LEFT)alignment by encoders for rotation.vi" Type="VI" URL="../../module Ilya/Libraries/Documents/AC sibsau/RoboProff/_MVA - Copy - DATA HighWay - Copy (22.11)/vision/project ILYA/movement/(LEFT)alignment by encoders for rotation.vi"/>
			<Item Name="(RIGHT)alignment by encoders for rotation.vi" Type="VI" URL="../../module Ilya/Libraries/Documents/AC sibsau/RoboProff/_MVA - Copy - DATA HighWay - Copy (22.11)/vision/project ILYA/movement/(RIGHT)alignment by encoders for rotation.vi"/>
			<Item Name="alignment by unt corner.vi" Type="VI" URL="../../module Ilya/Libraries/Documents/AC sibsau/RoboProff/_MVA - Copy - DATA HighWay - Copy (22.11)/vision/project ILYA/movement/alignment by unt corner.vi"/>
			<Item Name="de santimeters by encoder.vi" Type="VI" URL="../../module Ilya/Libraries/Documents/AC sibsau/RoboProff/_MVA - Copy - DATA HighWay - Copy (22.11)/vision/project ILYA/movement/de santimeters by encoder.vi"/>
			<Item Name="for axis(360) (SubVI).vi" Type="VI" URL="../../module Ilya/Libraries/Documents/AC sibsau/RoboProff/_MVA - Copy - DATA HighWay - Copy (22.11)/vision/project ILYA/movement/for axis(360) (SubVI).vi"/>
			<Item Name="forwardByNavX_theSide(queuesWithNavX).vi" Type="VI" URL="../../module Ilya/Libraries/Documents/AC sibsau/RoboProff/_MVA - Copy - DATA HighWay - Copy (22.11)/vision/project ILYA/movement/forwardByNavX_theSide(queuesWithNavX).vi"/>
			<Item Name="full.vi" Type="VI" URL="../../module Ilya/Libraries/Documents/AC sibsau/RoboProff/_MVA - Copy - DATA HighWay - Copy (22.11)/vision/project ILYA/movement/full.vi"/>
			<Item Name="motor (SubVI).vi" Type="VI" URL="../../module Ilya/Libraries/Documents/AC sibsau/RoboProff/_MVA - Copy - DATA HighWay - Copy (22.11)/vision/project ILYA/movement/motor (SubVI).vi"/>
			<Item Name="movement back by santimeters.vi" Type="VI" URL="../../module Ilya/Libraries/Documents/AC sibsau/RoboProff/_MVA - Copy - DATA HighWay - Copy (22.11)/vision/project ILYA/movement/movement back by santimeters.vi"/>
			<Item Name="movement forward by santimeters.vi" Type="VI" URL="../../module Ilya/Libraries/Documents/AC sibsau/RoboProff/_MVA - Copy - DATA HighWay - Copy (22.11)/vision/project ILYA/movement/movement forward by santimeters.vi"/>
			<Item Name="movement fwd use navX.vi" Type="VI" URL="../../module Ilya/Libraries/Documents/AC sibsau/RoboProff/_MVA - Copy - DATA HighWay - Copy (22.11)/vision/project ILYA/movement/movement fwd use navX.vi"/>
			<Item Name="movement(a side) fwd use navX and Sonic.vi" Type="VI" URL="../../module Ilya/Libraries/Documents/AC sibsau/RoboProff/_MVA - Copy - DATA HighWay - Copy (22.11)/vision/project ILYA/movement/movement(a side) fwd use navX and Sonic.vi"/>
			<Item Name="rotate(NORMALNOE ROTATE).vi" Type="VI" URL="../../module Ilya/Libraries/Documents/AC sibsau/RoboProff/_MVA - Copy - DATA HighWay - Copy (22.11)/vision/project ILYA/movement/rotate(NORMALNOE ROTATE).vi"/>
			<Item Name="rotation.vi" Type="VI" URL="../../module Ilya/Libraries/Documents/AC sibsau/RoboProff/_MVA - Copy - DATA HighWay - Copy (22.11)/vision/project ILYA/movement/rotation.vi"/>
			<Item Name="turn unt current.vi" Type="VI" URL="../../module Ilya/Libraries/Documents/AC sibsau/RoboProff/_MVA - Copy - DATA HighWay - Copy (22.11)/vision/project ILYA/movement/turn unt current.vi"/>
			<Item Name="value by encoders to santimeters for back (SubVI).vi" Type="VI" URL="../../module Ilya/Libraries/Documents/AC sibsau/RoboProff/_MVA - Copy - DATA HighWay - Copy (22.11)/vision/project ILYA/movement/value by encoders to santimeters for back (SubVI).vi"/>
			<Item Name="value by encoders to santimeters for forward (SubVI).vi" Type="VI" URL="../../module Ilya/Libraries/Documents/AC sibsau/RoboProff/_MVA - Copy - DATA HighWay - Copy (22.11)/vision/project ILYA/movement/value by encoders to santimeters for forward (SubVI).vi"/>
		</Item>
		<Item Name="Main.vi" Type="VI" URL="../../module Ilya/Libraries/Documents/AC sibsau/RoboProff/_MVA - Copy - DATA HighWay - Copy (22.11)/vision/machine vision app/qsm/Main.vi"/>
		<Item Name="Ball ROI (SubVI).vi" Type="VI" URL="../../module Ilya/Libraries/Documents/AC sibsau/RoboProff/_MVA/vision/Ball ROI (SubVI).vi"/>
		<Item Name="Ball Index (SubVI).vi" Type="VI" URL="../../module Ilya/Libraries/Documents/AC sibsau/RoboProff/_MVA/vision/Ball Index (SubVI).vi"/>
		<Item Name="Pattern Align(SubVI).vi" Type="VI" URL="../../module Ilya/Libraries/Documents/AC sibsau/RoboProff/_MVA - Copy - DATA HighWay - Copy (22.11)/vision/Pattern Align(SubVI).vi"/>
		<Item Name="(ball) Compare (SubVI).vi" Type="VI" URL="../../module Ilya/Libraries/Documents/AC sibsau/RoboProff/_MVA - Copy - DATA HighWay - Copy (22.11)/vision/(ball) Compare (SubVI).vi"/>
		<Item Name="Servo(s) (subVI).vi" Type="VI" URL="../../module Ilya/Libraries/Documents/AC sibsau/RoboProff/_MVA - Copy - DATA HighWay - Copy (22.11)/vision/Servo(s) (subVI).vi"/>
		<Item Name="Servo(m) (subVI).vi" Type="VI" URL="../../module Ilya/Libraries/Documents/AC sibsau/RoboProff/_MVA - Copy - DATA HighWay - Copy (22.11)/vision/Servo(m) (subVI).vi"/>
		<Item Name="navX x_y_z (SubVI).vi" Type="VI" URL="../../module Ilya/Libraries/Documents/AC sibsau/RoboProff/_MVA - Copy - DATA HighWay - Copy (22.11)/vision/navX x_y_z (SubVI).vi"/>
		<Item Name="align.vi" Type="VI" URL="../../module Ilya/Libraries/Documents/AC sibsau/RoboProff/_MVA - Copy - DATA HighWay - Copy (22.11)/vision/align.vi"/>
		<Item Name="fwd-navx (SubVI).vi" Type="VI" URL="../../module Ilya/Libraries/Documents/AC sibsau/RoboProff/_MVA - Copy - DATA HighWay - Copy (22.11)/vision/fwd-navx (SubVI).vi"/>
		<Item Name="vars.lvlib" Type="Library" URL="../../module Ilya/Libraries/Documents/AC sibsau/RoboProff/_MVA - Copy - DATA HighWay - Copy (22.11)/vision/vars.lvlib"/>
		<Item Name="sonic info (SubVI).vi" Type="VI" URL="../../module Ilya/Libraries/Documents/AC sibsau/RoboProff/_MVA - Copy - DATA HighWay - Copy (22.11)/vision/sonic info (SubVI).vi"/>
		<Item Name="Setup manipulator (SubVI).vi" Type="VI" URL="../../module Ilya/Libraries/Documents/AC sibsau/RoboProff/_MVA - Copy - DATA HighWay - Copy (22.11)/vision/Setup manipulator (SubVI).vi"/>
		<Item Name="test.vi" Type="VI" URL="../../module Ilya/Libraries/Documents/AC sibsau/RoboProff/_MVA - Copy - DATA HighWay - Copy (22.11)/vision/test.vi"/>
		<Item Name="(auto) Count balls (SubVI).vi" Type="VI" URL="../../module Ilya/Libraries/Documents/AC sibsau/RoboProff/_MVA - Copy - DATA HighWay - Copy (22.11)/vision/(auto) Count balls (SubVI).vi"/>
		<Item Name="Setup camera (SubVI).vi" Type="VI" URL="../../module Ilya/Libraries/Documents/AC sibsau/RoboProff/_MVA - Copy - DATA HighWay - Copy (22.11)/vision/Setup camera (SubVI).vi"/>
		<Item Name="(auto) SAVE.vi" Type="VI" URL="../../module Ilya/Libraries/Documents/AC sibsau/RoboProff/_MVA - Copy - DATA HighWay - Copy (22.11)/vision/(auto) SAVE.vi"/>
		<Item Name="(auto) Get State (SubVI).vi" Type="VI" URL="../../module Ilya/Libraries/Documents/AC sibsau/RoboProff/_MVA - Copy - DATA HighWay - Copy (22.11)/vision/(auto) Get State (SubVI).vi"/>
		<Item Name="Set Up auto (SubVI).vi" Type="VI" URL="../../module Ilya/Libraries/Documents/AC sibsau/RoboProff/_MVA - Copy - DATA HighWay - Copy (22.11)/vision/Set Up auto (SubVI).vi"/>
		<Item Name="Analyze ball (SubVI).vi" Type="VI" URL="../../module Ilya/Libraries/Documents/AC sibsau/RoboProff/_MVA - Copy - DATA HighWay - Copy (22.11)/vision/project ILYA/movement/Analyze ball (SubVI).vi"/>
		<Item Name="(auto) Skip same balls(SubVI).vi" Type="VI" URL="../../module Ilya/Libraries/Documents/AC sibsau/RoboProff/_MVA - Copy - DATA HighWay - Copy (22.11)/vision/(auto) Skip same balls(SubVI).vi"/>
		<Item Name="callback.vi" Type="VI" URL="../../module Ilya/Libraries/Documents/AC sibsau/RoboProff/_MVA - Copy - DATA HighWay - Copy (22.11)/vision/machine vision app/callback.vi"/>
		<Item Name="Untitled 7 (SubVI).vi" Type="VI" URL="../../module Ilya/Libraries/Documents/AC sibsau/RoboProff/_MVA - Copy - DATA HighWay - Copy (22.11)/vision/machine vision app/Untitled 7 (SubVI).vi"/>
		<Item Name="(auto) Analyze pattern.vi" Type="VI" URL="../../module Ilya/Libraries/Documents/AC sibsau/RoboProff/_MVA - Copy - DATA HighWay - Copy (22.11)/vision/machine vision app/(auto) Analyze pattern.vi"/>
		<Item Name="(auto) Recover def pos (SubVI).vi" Type="VI" URL="../../module Ilya/Libraries/Documents/AC sibsau/RoboProff/_MVA - Copy - DATA HighWay - Copy (22.11)/vision/machine vision app/(auto) Recover def pos (SubVI).vi"/>
		<Item Name="(auto) Go back controller.vi" Type="VI" URL="../../module Ilya/Libraries/Documents/AC sibsau/RoboProff/_MVA - Copy - DATA HighWay - Copy (22.11)/vision/machine vision app/(auto) Go back controller.vi"/>
		<Item Name="(auto) Go back Action.vi" Type="VI" URL="../../module Ilya/Libraries/Documents/AC sibsau/RoboProff/_MVA - Copy - DATA HighWay - Copy (22.11)/vision/machine vision app/(auto) Go back Action.vi"/>
		<Item Name="(auto) Set Manip.vi" Type="VI" URL="../../module Ilya/Libraries/Documents/AC sibsau/RoboProff/_MVA - Copy - DATA HighWay - Copy (22.11)/vision/machine vision app/(auto) Set Manip.vi"/>
		<Item Name="Find square (SubVI).vi" Type="VI" URL="../../module Ilya/Find square (SubVI).vi"/>
		<Item Name="Dependencies" Type="Dependencies">
			<Item Name="vi.lib" Type="Folder">
			...
			<Item Name="Ball Align(SubVI).vi" Type="VI" URL="../../module Ilya/Libraries/Documents/AC sibsau/RoboProff/_MVA - Copy - DATA HighWay - Copy (22.11)/vision/Ball Align(SubVI).vi"/>
			<Item Name="Pattern ROI (SubVI).vi" Type="VI" URL="../../module Ilya/Libraries/Documents/AC sibsau/RoboProff/_MVA - Copy - DATA HighWay - Copy (22.11)/vision/Pattern ROI (SubVI).vi"/>
			<Item Name="Joystick control (SubVI).vi" Type="VI" URL="../../module Ilya/Libraries/Documents/AC sibsau/RoboProff/_MVA - Copy - DATA HighWay - Copy (22.11)/vision/Joystick control (SubVI).vi"/>
			<Item Name="tunnel M2-M2.5.vi" Type="VI" URL="../../module Ilya/Libraries/Documents/AC sibsau/RoboProff/_MVA - Copy - DATA HighWay - Copy (22.11)/vision/project ILYA/movement/tunnel M2-M2.5.vi"/>
			<Item Name="get.p.vi" Type="VI" URL="../../module Ilya/Libraries/Documents/AC sibsau/RoboProff/_MVA - Copy - DATA HighWay - Copy (22.11)/vision/machine vision app/get.p.vi"/>
		</Item>
		<Item Name="Build Specifications" Type="Build"/>
	</Item>
</Project>
