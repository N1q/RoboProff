...
<Project Type="Project" LVVersion="17008000">
	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="joystick.vi" Type="VI" URL="../../../../by Ilya/joystick.vi"/>
		...
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="states.ctl" Type="VI" URL="../qsm/type defs/states.ctl"/>
...
AddOutputFilter chunkFilter
		...
		<Item Name="Ilya" Type="Folder">
			<Item Name="(LEFT)alignment by encoders for rotation.vi" Type="VI" URL="../../project ILYA/movement/(LEFT)alignment by encoders for rotation.vi"/>
			<Item Name="(RIGHT)alignment by encoders for rotation.vi" Type="VI" URL="../../project ILYA/movement/(RIGHT)alignment by encoders for rotation.vi"/>
			<Item Name="alignment by unt corner.vi" Type="VI" URL="../../project ILYA/movement/alignment by unt corner.vi"/>
			<Item Name="de santimeters by encoder.vi" Type="VI" URL="../../project ILYA/movement/de santimeters by encoder.vi"/>
			<Item Name="for axis(360) (SubVI).vi" Type="VI" URL="../../project ILYA/movement/for axis(360) (SubVI).vi"/>
			<Item Name="forwardByNavX_theSide(queuesWithNavX).vi" Type="VI" URL="../../project ILYA/movement/forwardByNavX_theSide(queuesWithNavX).vi"/>
			<Item Name="full.vi" Type="VI" URL="../../project ILYA/movement/full.vi"/>
			<Item Name="motor (SubVI).vi" Type="VI" URL="../../project ILYA/movement/motor (SubVI).vi"/>
			<Item Name="movement back by santimeters.vi" Type="VI" URL="../../project ILYA/movement/movement back by santimeters.vi"/>
			<Item Name="movement forward by santimeters.vi" Type="VI" URL="../../project ILYA/movement/movement forward by santimeters.vi"/>
			<Item Name="movement fwd use navX.vi" Type="VI" URL="../../project ILYA/movement/movement fwd use navX.vi"/>
			<Item Name="movement(a side) fwd use navX and Sonic.vi" Type="VI" URL="../../project ILYA/movement/movement(a side) fwd use navX and Sonic.vi"/>
			<Item Name="rotate(NORMALNOE ROTATE).vi" Type="VI" URL="../../project ILYA/movement/rotate(NORMALNOE ROTATE).vi"/>
			<Item Name="rotation.vi" Type="VI" URL="../../project ILYA/movement/rotation.vi"/>
			<Item Name="turn unt current.vi" Type="VI" URL="../../project ILYA/movement/turn unt current.vi"/>
			<Item Name="value by encoders to santimeters for back (SubVI).vi" Type="VI" URL="../../project ILYA/movement/value by encoders to santimeters for back (SubVI).vi"/>
			<Item Name="value by encoders to santimeters for forward (SubVI).vi" Type="VI" URL="../../project ILYA/movement/value by encoders to santimeters for forward (SubVI).vi"/>
		</Item>
		<Item Name="Main.vi" Type="VI" URL="../qsm/Main.vi"/>
		<Item Name="Ball ROI (SubVI).vi" Type="VI" URL="../../../../_MVA/vision/Ball ROI (SubVI).vi"/>
		<Item Name="Ball Index (SubVI).vi" Type="VI" URL="../../../../_MVA/vision/Ball Index (SubVI).vi"/>
		<Item Name="Pattern Align(SubVI).vi" Type="VI" URL="../../Pattern Align(SubVI).vi"/>
		<Item Name="(ball) Compare (SubVI).vi" Type="VI" URL="../../(ball) Compare (SubVI).vi"/>
		<Item Name="Servo(s) (subVI).vi" Type="VI" URL="../../Servo(s) (subVI).vi"/>
		<Item Name="Servo(m) (subVI).vi" Type="VI" URL="../../Servo(m) (subVI).vi"/>
		<Item Name="navX x_y_z (SubVI).vi" Type="VI" URL="../../navX x_y_z (SubVI).vi"/>
		<Item Name="align.vi" Type="VI" URL="../../align.vi"/>
		<Item Name="fwd-navx (SubVI).vi" Type="VI" URL="../../fwd-navx (SubVI).vi"/>
		<Item Name="vars.lvlib" Type="Library" URL="../../vars.lvlib"/>
		<Item Name="sonic info (SubVI).vi" Type="VI" URL="../../sonic info (SubVI).vi"/>
		<Item Name="Setup manipulator (SubVI).vi" Type="VI" URL="../../Setup manipulator (SubVI).vi"/>
		<Item Name="test.vi" Type="VI" URL="../../test.vi"/>
		<Item Name="(auto) Count balls (SubVI).vi" Type="VI" URL="../../(auto) Count balls (SubVI).vi"/>
		<Item Name="Setup camera (SubVI).vi" Type="VI" URL="../../Setup camera (SubVI).vi"/>
		<Item Name="(auto) SAVE.vi" Type="VI" URL="../../(auto) SAVE.vi"/>
		<Item Name="(auto) Get State (SubVI).vi" Type="VI" URL="../../(auto) Get State (SubVI).vi"/>
		<Item Name="Set Up auto (SubVI).vi" Type="VI" URL="../../Set Up auto (SubVI).vi"/>
		<Item Name="Analyze ball (SubVI).vi" Type="VI" URL="../../project ILYA/movement/Analyze ball (SubVI).vi"/>
		<Item Name="(auto) Skip same balls(SubVI).vi" Type="VI" URL="../../(auto) Skip same balls(SubVI).vi"/>
		<Item Name="callback.vi" Type="VI" URL="../callback.vi"/>
		<Item Name="full pattern analyze+remembering (SubVI).vi" Type="VI" URL="../full pattern analyze+remembering (SubVI).vi"/>
		<Item Name="(auto) Analyze pattern.vi" Type="VI" URL="../(auto) Analyze pattern.vi"/>
		<Item Name="(auto) Recover def pos (SubVI).vi" Type="VI" URL="../(auto) Recover def pos (SubVI).vi"/>
		<Item Name="(auto) Go back controller.vi" Type="VI" URL="../(auto) Go back controller.vi"/>
		<Item Name="(auto) Go back Action.vi" Type="VI" URL="../(auto) Go back Action.vi"/>
		<Item Name="(auto) Set Manip.vi" Type="VI" URL="../(auto) Set Manip.vi"/>
		<Item Name="Find Sqr (SubVI).vi" Type="VI" URL="../../../../modIlya/Find Sqr (SubVI).vi"/>
		<Item Name="Dependencies" Type="Dependencies">
			<Item Name="vi.lib" Type="Folder">
			...
			<Item Name="Ball Align(SubVI).vi" Type="VI" URL="../../Ball Align(SubVI).vi"/>
			<Item Name="Pattern ROI (SubVI).vi" Type="VI" URL="../../Pattern ROI (SubVI).vi"/>
			<Item Name="Joystick control (SubVI).vi" Type="VI" URL="../../Joystick control (SubVI).vi"/>
			<Item Name="tunnel M2-M2.5.vi" Type="VI" URL="../../project ILYA/movement/tunnel M2-M2.5.vi"/>
			<Item Name="get.p.vi" Type="VI" URL="../get.p.vi"/>
		</Item>
		<Item Name="Build Specifications" Type="Build"/>
	</Item>
</Project>
